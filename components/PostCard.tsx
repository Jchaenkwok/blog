...
// const PostCard = ({ title, excerpt }: PostProps): JSX.Element => {
const PostCard = ({ post }: { post: PostProps }): JSX.Element => {
    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            <h1 className='transition duration-700 text-center mb-8 cursor-pointer hover:text-blue-500 text-3xl font-semibold'>
